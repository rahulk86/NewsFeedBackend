...
import com.NewFeed.backend.repository.user.feed.UserCommentRepository;
import com.NewFeed.backend.repository.user.feed.UserPostRepository;
import com.NewFeed.backend.repository.user.UserProfileRepository;
import com.NewFeed.backend.repository.user.feed.UserReplyRepository;
